...
export const ExpandIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg 
        ...
        className={className}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m-9 6l-5.25 5.25m0 0v-4.5m0 4.5h4.5M20.25 20.25v-4.5m0 4.5h-4.5m4.5 0L15 15" />
    </svg>
);
...
export const ShareIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg 
        ...
        className={className}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.583.042h6.11a2.25 2.25 0 100-2.186m-6.11 2.186L6.5 12.5m.717-1.593l.536-.426a2.25 2.25 0 012.829 0l.536.426m-3.9 2.186l.536.426a2.25 2.25 0 002.829 0l.536-.426m-6.5 4.385l.754-.62a2.25 2.25 0 012.829 0l.754.62a3.375 3.375 0 004.283 0l.754-.62a2.25 2.25 0 012.829 0l.754.62a2.25 2.25 0 100-2.186m-16.5 2.186a2.25 2.25 0 100-2.186m16.5 0a2.25 2.25 0 100 2.186" />
    </svg>
);
...
export const CompareHandleIcon: React.FC<{ className?: string }> = ({ className }) => (
